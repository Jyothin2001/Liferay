package appointment.scheduling.headlessAPI.rest.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	public Response addAppointment(
		...
		return _applyComponentServiceObjects(
			...
			appointmentResource -> appointmentResource.addAppointment(
				appointment));
	}
	...
	public Response deleteAppointmentBatch(
		...
		return _applyComponentServiceObjects(
			_appointmentResourceComponentServiceObjects,
			this::_populateResourceContext,
			appointmentResource -> appointmentResource.deleteAppointmentBatch(
				callbackURL, object));
	}
