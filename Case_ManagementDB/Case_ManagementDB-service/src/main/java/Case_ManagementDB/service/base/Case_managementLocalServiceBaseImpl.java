...
import Case_ManagementDB.service.Case_managementLocalService;
...
/**
 * Provides the base implementation for the case_management local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link Case_ManagementDB.service.impl.Case_managementLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see Case_ManagementDB.service.impl.Case_managementLocalServiceImpl
 * @generated
 */
public abstract class Case_managementLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, Case_managementLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>Case_managementLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>Case_ManagementDB.service.Case_managementLocalServiceUtil</code>.
	 */
	...
	public Case_management addCase_management(Case_management case_management) {
		...
		return case_managementPersistence.update(case_management);
	}
	...
	public Case_management createCase_management(long caseId) {
		return case_managementPersistence.create(caseId);
	}
	...
	public Case_management deleteCase_management(long caseId)
		...
		return case_managementPersistence.remove(caseId);
	}
	...
	public Case_management deleteCase_management(
		...
		return case_managementPersistence.remove(case_management);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return case_managementPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Case_management.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return case_managementPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return case_managementPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return case_managementPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return case_managementPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Case_management fetchCase_management(long caseId) {
		return case_managementPersistence.fetchByPrimaryKey(caseId);
	}
	...
	public Case_management fetchCase_managementByUuidAndGroupId(
		...
		return case_managementPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Case_management getCase_management(long caseId)
		...
		return case_managementPersistence.findByPrimaryKey(caseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(case_managementLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Case_management.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Case_management.class);
			...
			new ActionableDynamicQuery.PerformActionMethod<Case_management>() {
				...
				public void performAction(Case_management case_management)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, case_management);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return case_managementPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement Case_managementLocalServiceImpl#deleteCase_management(Case_management) to avoid orphaned data");
		}

		return case_managementLocalService.deleteCase_management(
			(Case_management)persistedModel);
	}

	@Override
	public BasePersistence<Case_management> getBasePersistence() {
		return case_managementPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return case_managementPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Case_management> getCase_managementsByUuidAndCompanyId(
		...
		return case_managementPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Case_management> getCase_managementsByUuidAndCompanyId(
		...
		return case_managementPersistence.findByUuid_C(
	...
	public Case_management getCase_managementByUuidAndGroupId(
		...
		return case_managementPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Case_management> getCase_managements(int start, int end) {
		return case_managementPersistence.findAll(start, end);
	}
	...
	public int getCase_managementsCount() {
		return case_managementPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			Case_managementLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		case_managementLocalService = (Case_managementLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return Case_managementLocalService.class.getName();
	}
	...
	protected Case_managementLocalService case_managementLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		Case_managementLocalServiceBaseImpl.class);
