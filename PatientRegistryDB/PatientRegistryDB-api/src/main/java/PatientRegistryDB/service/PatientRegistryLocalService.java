...
/**
 * Provides the local service interface for PatientRegistry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PatientRegistryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PatientRegistryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>PatientRegistryDB.service.impl.PatientRegistryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the patient registry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PatientRegistryLocalServiceUtil} if injection and service tracking are not available.
	 */
