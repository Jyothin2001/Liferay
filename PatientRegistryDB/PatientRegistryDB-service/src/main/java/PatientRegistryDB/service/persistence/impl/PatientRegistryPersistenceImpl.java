...
public class PatientRegistryPersistenceImpl
	 ...
	 */
	@Override
	public List<PatientRegistry> findByUserId(long userId) {
	 ...
	 */
	@Override
	public List<PatientRegistry> findByUserId(long userId, int start, int end) {
	 ...
	 */
	@Override
	public List<PatientRegistry> findByUserId(
	...
	public List<PatientRegistry> findByUserId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (PatientRegistry patientRegistry : list) {
					if (userId != patientRegistry.getUserId()) {
						list = null;
	...
	public PatientRegistry findByUserId_First(
		...
		PatientRegistry patientRegistry = fetchByUserId_First(
	...
	public PatientRegistry fetchByUserId_First(
		...
		List<PatientRegistry> list = findByUserId(
	...
	public PatientRegistry findByUserId_Last(
		...
		PatientRegistry patientRegistry = fetchByUserId_Last(
			userId, orderByComparator);
	...
	public PatientRegistry[] findByUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(
				session, patientRegistry, userId, orderByComparator, true);

			array[1] = patientRegistry;

			array[2] = getByUserId_PrevAndNext(
				session, patientRegistry, userId, orderByComparator, false);
	...
	protected PatientRegistry getByUserId_PrevAndNext(
		Session session, PatientRegistry patientRegistry, long userId,
		OrderByComparator<PatientRegistry> orderByComparator,
		boolean previous) {
