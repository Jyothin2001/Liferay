 ...
 * @generated
 */
public abstract class BankTableFinderBaseImpl
	extends BasePersistenceImpl<BankTable> {

	public BankTableFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return bankTablePersistence.getBadColumnNames();
	}
